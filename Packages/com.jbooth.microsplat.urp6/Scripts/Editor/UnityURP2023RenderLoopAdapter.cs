...
{
   public class UnityURP2023RenderLoopAdapter : IRenderLoopAdapter
   {
      ...
      {
         return "_MSRENDERLOOP_UNITYURP6";
      }
      ...
      public void Init(string[] paths)
      {
         ...
         {
            string p = paths[i];
            if (p.EndsWith("microsplat_template_urp6_template.txt"))
            {
            ...
            else if (p.EndsWith("microsplat_template_urp6_passterrain.txt"))
            {
            ...
            else if (p.EndsWith("microsplat_template_urp6_passdepthnormals.txt"))
            {
               templatePassDepthNormals = AssetDatabase.LoadAssetAtPath<TextAsset>(p);
            }
            else if (p.EndsWith("microsplat_template_urp6_passforward.txt"))
            {
               templatePassForward = AssetDatabase.LoadAssetAtPath<TextAsset>(p);
            }
            else if (p.EndsWith("microsplat_template_urp6_passdepthonly.txt"))
            {
               templatePassDepthOnly = AssetDatabase.LoadAssetAtPath<TextAsset>(p);
            }
            else if (p.EndsWith("microsplat_template_urp6_passmeta.txt"))
            {
               templatePassMeta = AssetDatabase.LoadAssetAtPath<TextAsset>(p);
            }
            else if (p.EndsWith("microsplat_template_urp6_passhadows.txt"))
            {
               templatePassShadow = AssetDatabase.LoadAssetAtPath<TextAsset>(p);
            }
            else if (p.EndsWith ("microsplat_template_urp6_passgbuffer.txt"))
            {
               templatePassGBuffer = AssetDatabase.LoadAssetAtPath<TextAsset> (p);
            }
            else if (p.EndsWith ("microsplat_template_urp6_passmotion.txt"))
            {
            ...
            else if (p.EndsWith("microsplat_template_urp6_vert.txt"))
            {
               templateVert = AssetDatabase.LoadAssetAtPath<TextAsset>(p);
            }
            else if (p.EndsWith("microsplat_template_urp6_include.txt"))
            {
      ...
      StringBuilder BuildTemplate(Blocks blocks, string[] features, string fallbackOverride = null)
      {
         ...
         header.AppendLine("//   Render Pipeline: URP2023");
