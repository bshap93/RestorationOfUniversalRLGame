...
namespace Project.Gameplay.Interactivity.Items
{
	...
	/// </summary>
	public class InventoryItem : ScriptableObject, IPreviewable 
	{
		
		public void ShowPreview()
		{
			// We should call the PreviewManager to show this item
		...
		{
			// We should call the PreviewManager to hide this item
			MMEventManager.TriggerEvent(new PreviewEvent
			{
		...
		public PreviewType GetPreviewType() => PreviewType.ItemPickup;
		public float GetPreviewPriority() => 1.0f;
