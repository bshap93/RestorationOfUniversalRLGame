...
namespace Gameplay.Extensions.InventoryEngineExtensions.Craft
{
            ...
            MMFeedbacks deniedFeedback = null)
        {
            ...
            try
            {
                ...
                if (inventory.AddItem(recipe.Item, recipe.Quantity))
                {
                    ...
                    RecipeEvent.Trigger("CraftingFinished", RecipeEventType.CraftingFinished, recipe);
    ...
    public class RecipeGroup : ScriptableObject
    {
        ...
        public static RecipeGroup RetrieveCraftGroup(string recipeGroupIndex)
        {
            var recipeGroup = Resources.Load<RecipeGroup>($"Crafting/RecipeGroups/{recipeGroupIndex}");
            if (recipeGroup == null)
                Debug.LogError($"Recipe group not found: {recipeGroupIndex}");
