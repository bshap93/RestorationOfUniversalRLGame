...
//         [NonSerialized] List<ManualItemPicker>
//             _currentPreviewedItemPickers = new();
//
...
//         public PlayerItemPreviewManager(List<InventoryItem> currentPreviewedItems)
//         {
//             CurrentPreviewedItems = currentPreviewedItems;
//         }
//         List<InventoryItem> CurrentPreviewedItems { get; set; }
//
//
//         void Awake()
//         {
...
//
//
//             var isPreviewed = _currentPreviewedItemPickers.Count != 0 &&
//                               _currentPreviewedItemPickers.Any(picker => picker.UniqueID == itemPicker.UniqueID);
//
//             return isPreviewed;
//         }
//
...
//
//             if (_currentPreviewedItemPickers.All(picker => picker.UniqueID != itemPicker.UniqueID)) return false;
//
//             _isPickingUp = true;
...
//                     {
//                         _currentPreviewedItemPickers = new List<ManualItemPicker>();
...
//                 if (_itemPickersInRange.Count == 0)
//                 {
//                     if (_currentPreviewedItemPickers.Count == 0)
//                     {
//                         _currentPreviewedItemPickers = new List<ManualItemPicker>();
//                         CurrentPreviewedItems = new List<InventoryItem>();
//                         _previewManager.HideItemListPreview();
...
//                     .FirstOrDefault();
//
//                 if (closestPicker != null && (_currentPreviewedItemPickers.Count == 0 ||
//                                               _currentPreviewedItemPickers.All(
//                                                   picker => picker.UniqueID != closestPicker.UniqueID)))
...
//         {
//             CurrentPreviewedItems.Add(itemPicker.Item);
//             _currentPreviewedItemPickers.Add(itemPicker);
//         }
//
//
