    ...
    public class Pursue : NavMeshMovement
    {
        ...
        Vector3 Target()
        {
            ...
            if (speed <= distance / m_TargetDistPrediction.Value)
                ...
                futurePrediction =
                    distance / speed * m_TargetDistPredictionMult.Value; // the prediction should be accurate enough
